      ...
      <div className="relative max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {services.map((service) => (
            <div 
              key={service.title}
              className="group relative p-8 rounded-3xl bg-card border border-border hover:border-primary/50 transition-all duration-300 flex flex-col"
            >
              ...
              <Button variant="ghost" className="justify-start p-0 h-auto text-primary hover:text-primary/80 hover:bg-transparent">
                {service.cta} →
              </Button>
            </div>
          ))}
